...
class SpeechToText:
    def __init__(self, model_size: str = "base"):
        """
        Initialize the Speech-to-Text engine using speech_recognition library
    ...
    def record_audio_continuous(self) -> str:
        """
        ...
        Returns:
            Transcribed text
        """
        print("🎤 Start speaking... (will stop automatically when you finish)")
...
if __name__ == "__main__":
    try:
        ...
        text = stt.record_audio_continuous()
        print(f"Result: {text}")
